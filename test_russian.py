...
class TestVOT(unittest.TestCase):
	...
	def test_allVoicelessPalatalized(self):  #2
		...
		stops in russian.'''
		calculateVOT("russian_tests/MaSS_Russian2.wav", "russian_tests/MaSS_Russian2.TextGrid", ["p_j", "t_j", "k_j"])
	...
	def test_noPalatalizedVelarStops(self):  #3
	...
	def test_allVoicelessRussianStops(self):  #4
	...
	def test_onlyPalatalizedVelarStops(self):  #5
